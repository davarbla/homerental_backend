...
class InstallModel extends Model
{
    ...
    public function getTotal($os='') {
        $sql = " SELECT count(id_install) as total FROM tb_install ";
        if ($os != '') {
            $sql = " SELECT count(id_install) as total FROM tb_install WHERE os_platform='".$os."'  ";
        }
