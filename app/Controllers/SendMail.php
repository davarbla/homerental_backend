...
class SendMail extends BaseController
{
    ...
    private $fromEmail = 'noreply@hobbbies.id';
    private $fromName = 'Noreply Hobbbies';
    ...
    function sendMail() { 
        ...
        if ($to != '') {
            ...
            if ($checkInstall['id_install'] != '' && $checkExist['id_user'] != '') {
                ...
                $message = 'Code verify for reset password.<br/><br/><strong>'.$rand.'</strong><br/><br/>Best Regards, <br/>Hobbbies Apps'; 
