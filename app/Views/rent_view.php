...
<body>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Data Rent</strong> &nbsp;&nbsp; <button type="button"
                                class="btn btn-primary btn-sm"
                                onclick="javascript:window.location.href='/rent?ac=add';">Add New</button>
                        </div>
                        <div class="card-body">
                            <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    <?php foreach($result as $row) { 
                                        ...
                                        ?>
                                    <tr>
                                        <td><?php echo $row['id_rent'];?></td>
                                        <td><?php echo $row['title'];?><br /><?php echo $row['address'];?></td>
                                        <td class="avatar">
                                            <div class="round-img">
                                        ...
                                        <td><?php echo $row['currency'];?>.<?php echo $row['price'];?>
                                            /<?php echo $row['unit_price'];?></td>
                                        <td><?php echo $row['total_liked'];?></td>
                                        <td><?php echo $row['total_rent'];?></td>
                                        <td>
                                            <span class="badge <?php echo $bgStatus;?>"><?php echo $status;?></span>
                                        </td>
                                        <td>
                                            <a href="rent?ac=edit&id=<?php echo $row['id_rent'];?>"
                                                class="btn btn-info btn-sm">Update</a> &nbsp;&nbsp;<button
                                                class="btn btn-danger btn-sm"
                                                onClick="return confirmModal(<?php echo $row['id_rent'];?>);">Delete</button>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
    ...
    confirmModal = function(id) {
        ...
        if (r == true) {
            window.location.href = 'rent/delete?id=' + id;
        }
